...
---------------------------------------QA Testing---------------------------------------
--Create a HR Database, Write SQL Queries and Create a test document of QA--

/* ---------What are the skills that I can acquire from this project?---------

   *Data Validation using SQL Queries
   *How to create a database, insert table in database
   *Write basic and advanced SQL Queries
   *Different SQL functions like SELECT, INSERT, WHERE, GROUP BY, ORDER BY, HAVING,
    ROUND(), SUBQUERIES, Data types,etc.
...
FROM hrdata
WHERE attrition = 'Yes' AND job_role = 'Sales Executive'; w
...
SELECT COUNT(active_employee) AS active_employee
FROM hrdata
